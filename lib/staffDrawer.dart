                ...
                child: ExpansionTile(
                  ...
                  children: [
                    Padding(
                      ...
                      child: ListTile(
                        minTileHeight: 15,
                        title: Text('Users', style: TextStyle(decoration: TextDecoration.underline, decorationColor: Colors.teal),),
                        onTap: () { },
                        textColor: Colors.teal,
                      ),
                    ),
                    Padding(
                      ...
                      child: ListTile(
                        minTileHeight: 15,
                        title: Text('Customers', style: TextStyle(decoration: TextDecoration.underline, decorationColor: Colors.teal),),
                        onTap: () {},
                        textColor: Colors.teal,
                      ),
                    ),
                    Padding(
                      ...
                      child: ListTile(
                        minTileHeight: 15,
                        title: Text('Managers', style: TextStyle(decoration: TextDecoration.underline, decorationColor: Colors.teal),),
                        onTap: () {},
                        textColor: Colors.teal,
                      ),
                    ),
