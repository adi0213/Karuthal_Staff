...
class StudentDrawer extends StatelessWidget {
  ...
  StudentDrawer(
      {required this.details, required this.token, required this.studentId});
            ...
            onTap: () async {
              ...
              try {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => StudentAssignedServices(
                      token: token,
                      studentId: studentId,
                      details: details,
                    ),
          ...
          ListTile(
            ...
            onTap: () {
              ...
              Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => CompleteWorkLogForm(
                          token: token,
                          studentId: studentId,
                          details: details,
                        )),
              ...
              Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (context) => StudentWorkLogHistory(
                        token: token, studentId: studentId, details: details)),
              );
            },
          ),
          ListTile(
