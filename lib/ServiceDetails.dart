...
class ServiceDetails extends StatefulWidget {
  ...
  const ServiceDetails(
      {super.key, required this.token, required this.bookingId});
...
class _ServiceDetailsState extends State<ServiceDetails> {
  ...
  Future<Map<String, dynamic>> getBookingDetails() async {
    ...
    var bookingDetails = await http.get(
        Uri.parse(
            "http://104.237.9.211:8007/karuthal/api/v1/bookingrequest/${widget.bookingId}"),
        headers: headers);
  ...
  Future<void> assignStudents() async {
    ...
    try {
      var response = await http.put(
          Uri.parse(
              "http://104.237.9.211:8007/karuthal/api/v1/staff/assignstudents"),
          headers: headers,
              ...
              itemBuilder: (context, index) {
                ...
                return ListTile(
                  ...
                  subtitle: Column(
                    ...
                    children: [
                      Text(
                          "Name: ${student['registeredUser']['firstName']} ${student['registeredUser']['lastName']}"),
                      Text(
                          "Username: ${student['registeredUser']['username']}"),
                    ],
                  ),
