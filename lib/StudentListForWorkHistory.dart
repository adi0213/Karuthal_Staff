import 'package:chilla_staff/StudentWorklogHistory.dart';
import 'package:flutter/material.dart';
import 'package:http/http.dart' as http;
import 'dart:convert';

class StudentsListForWorkHistory extends StatefulWidget {
  final String token;
  const StudentsListForWorkHistory({super.key, required this.token});
  @override
  State<StudentsListForWorkHistory> createState() =>
      _StudentsListForWorkHistory();
}

class _StudentsListForWorkHistory extends State<StudentsListForWorkHistory> {
                  ...
                  InkWell(
                    onTap: () => {
                      ...
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => StudentWorkLogHistory(
                                  token: widget.token,
