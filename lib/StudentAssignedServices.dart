...
class StudentAssignedServices extends StatefulWidget {
  ...
  const StudentAssignedServices(
      {super.key, required this.token, required this.studentId, required this.details});
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // ExpansionTile to make the services list foldable
              ExpansionTile(
                title: const Text(
                ...
                children: [
                  for (int i = 0; i < currentBookingDetails!['requestedServices'].length; i++)
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const Divider(),
                          ...
                          children: [
                            ...
                            TableRow(
                              children: [
                                ...
                                const Text(":"),
                                getValue(currentBookingDetails!['requestedServices'][i]['valueAdded']),
                              ],
                            ),
                          ],
                        ),
